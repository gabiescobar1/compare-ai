    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-[#251605]/97 backdrop-blur-sm border-b border-stone-200 dark:border-white/8 shadow-sm px-6 py-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/resultados" className="flex items-center gap-2 text-sm font-semibold text-[#1C1008] dark:text-[#f0e4d4] hover:opacity-80 transition-opacity uppercase tracking-wider">
            <IconListDetails className="w-4 h-4" /> Histórico
          </Link>
          <div className="w-[1px] h-4 bg-stone-300 dark:bg-white/15"></div>
          <Link href="/analytics" className="flex items-center gap-2 text-sm font-semibold text-[#1C1008] dark:text-[#f0e4d4] hover:opacity-80 transition-opacity uppercase tracking-wider">
